    ...
    override fun onBindViewHolder(holder: QuoteViewHolder, position: Int) {
        ...
        with(holder.binding) {
            with(quote) {
                ...
                lastPriceTv.text = String.format(priceQuote, lastTradePrice, percentChangeFromPreviousClose)
                quoteChangePriceTv.text = String.format(changePricePercent, priceChangeInPoints)
            }
        }
    }
}